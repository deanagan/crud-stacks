...
GO
INSERT INTO [dbo].[Roles]([Id], [UniqueId], [Kind], [Description], [Created])
VALUES(1, 'B7D50830-622B-443C-8BC8-AAB6D1C6C3C4', 'Scrum Master', 'A scrum master has more administration rights.', getdate())

INSERT INTO [dbo].[Roles]([Id], [UniqueId], [Kind], [Description], [Created])
VALUES(2, '804F7003-5777-4471-B1D4-B793D3FB643C', 'Developer', 'A developer can do basic operations.', getdate())
GO
...
GO
INSERT INTO [dbo].[Users]([Id], [UniqueId], [FirstName], [LastName], [Email], [Hash], [Created], [RoleId])
...
GO
INSERT INTO [dbo].Todo([Id], [UniqueId], [Summary], [Detail], [IsDone], [Created], [UserId])
